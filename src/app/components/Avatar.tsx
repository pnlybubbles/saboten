...
export default function Avatar({ name, className, mini, noNegative }: Props) {
  ...
  return (
    <div
      className={clsx(
        'relative grid place-items-center overflow-hidden rounded-full text-lg font-bold [container-type:size]',
    ...
    >
      {emoji && (
        <div
          className={clsx(
            'absolute scale-[16] transform-gpu blur-[10cqh] brightness-150 saturate-50 [font-size:100cqh]',
          )}
        >
          {head}
        </div>
